...
function removeHeroHighlight(){$(".hero-select").removeClass("hero-highlight")}function updateDraft(a,b){var c=$(".draft-item > img[data-order='"+b+"']"),d=$(".hero-select[data-hero='"+a+"']"),e=d.attr("src");$(c).attr("src",e);lockHero(d)}function updateTurnIndicator(a){removeTurnIndicator();turnIndicator(a+1)}function updateHistory(a){a=$jscomp.makeIterator(a);for(var b=a.next();!b.done;b=a.next())b=b.value,updateDraft(b.message,b.index)};
